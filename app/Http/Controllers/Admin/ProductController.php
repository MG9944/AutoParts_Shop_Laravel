...
// --------------------- add product ------------------ 
    ...
    public function updateProduct(Request $request){
        ...
        return Redirect()->route('manage-products')->with('success','Produkt zaktualizowany');
    }
    ...
    public function destroy($product_id){
        ...
        return Redirect()->back()->with('delete','Produkt usuniety');
    }

     // status inactive 
     public function Inactive($product_id){
        Product::findOrFail($product_id)->update(['status' => 0]);
        return Redirect()->back()->with('status','Produkt dezaktywowany');
    }
    ...
    public function Active($product_id){
        ...
        return Redirect()->back()->with('status','Produkt aktywowany');
    }
}
